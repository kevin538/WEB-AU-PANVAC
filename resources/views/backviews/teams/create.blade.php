                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="designationfr" id="input-username" class="form-control" placeholder="Directeur">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-email">Designation English </label>
                                    <input type="text" name="designationen" id="input-username" class="form-control" placeholder="Director"
                                        >
                                </div>
                            </div>
                        </div>
