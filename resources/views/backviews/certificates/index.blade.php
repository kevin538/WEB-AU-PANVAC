        ...
        <div class="col">
            ...
            <div class="card">
                ...
                <div class="card-header border-0" style="display: flex; justify-content: space-between; align-items: center;">
                    <h3 class="mb-0">Certificates table</h3>

                    {{-- // creer  quand c'est vide et edit quand c'est plein --}}
                    <a class="nav-link" href="{{ route('createcertificate') }}" style="font-size: 40px;">
                        ...
                        <thead class="thead-light">
                            <tr>
                               {{--  <th scope="col" class="sort" data-sort="name">Code</th> --}}
                                ...
                                <th scope="col" class="sort" data-sort="budget">Submitted BY</th>
                                <th scope="col" class="sort" data-sort="status">Vaccine Type</th>
                                <th scope="col">Batch Number</th>
                                <th scope="col" class="sort" data-sort="completion">ExpiredDate</th>
                                <th scope="col"></th>
                            </tr>
                        </thead>
                        <tbody class="list">
                                   ...
                                   {{--  <th scope="row">
                                    ...
                                    <td>
                                        <span class="badge badge-dot mr-4">
                                            <span class="status"> {{ $team->VaccineType }}</span>
                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge badge-dot mr-4">
                                            <span class="status"> {{ $team->BatchNumber }}</span>
                                        </span>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="completion mr-2">{{ $team->DateExpired }}</span>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                ...
                                                <form action="{{ route('certificate.destroy', $team->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
