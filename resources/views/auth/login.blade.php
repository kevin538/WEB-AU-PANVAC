                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                            ...
                            <p class="text-lead text-white">This place, is restricted to authorized users only.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <form method="POST" role="form" action="{{ route('login') }}">
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        ...
                                        <input id="email" type="email"
                                            ...
                                            value="{{ old('email') }}" placeholder="test@gmail.com" required
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="submit" style="background-color: #479a5c ; ; border-color:#479a5c"
            ...
            <div class="row align-items-center justify-content-xl-between">
                <div class="col-xl-6">
                    <div class="copyright text-center text-xl-left text-muted">
                        &copy; 2023 <a href="/" class="font-weight-bold ml-1" style="color: #479a5c" target="_blank">AU-PANVAC</a>
                    </div>
                </div>
            </div>
        </div>
