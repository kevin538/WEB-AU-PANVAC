            ...
            <div class="row">
                <div class="col-lg-3 wow fadeIn" data-wow-delay=".1s">
                    <div class="d-flex counter">
                        <h1 class="me-3 text-primary counter-value">{{ $globalData['latestContact']['NombreService'] ?? '' }}</h1>
                        <h5 class="text-white mt-1">Success in getting Happy Customer</h5>
                    </div>
                </div>
                <div class="col-lg-3 wow fadeIn" data-wow-delay=".3s">
                    <div class="d-flex counter">
                        <h1 class="me-3 text-primary counter-value">{{ $globalData['latestContact']['NombreTeams'] ?? '' }}</h1>
                        <h5 class="text-white mt-1">Thousands of Teams Members</h5>
                    </div>
                </div>
                <div class="col-lg-3 wow fadeIn" data-wow-delay=".5s">
                    <div class="d-flex counter">
                        <h1 class="me-3 text-primary counter-value">{{ $globalData['latestContact']['NombreCertifiedcertificate'] ?? '' }}</h1>
                        <h5 class="text-white mt-1">Certified Certificate</h5>
                    </div>
                </div>
                <div class="col-lg-3 wow fadeIn" data-wow-delay=".7s">
                    <div class="d-flex counter">
                        <h1 class="me-3 text-primary counter-value">{{ $globalData['latestContact']['Nombretestinprogrss'] ?? '' }}</h1>
