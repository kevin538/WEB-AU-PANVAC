...
@section('frontcontent')
    ...
    <div class="container-fluid page-header py-5"
        style="background: linear-gradient(rgba(0, 0, 0, .6), rgba(0, 0, 0, .6)), url('{{ asset('sliders/' . $globalData['latestContact']['ImageCarousel'] ?? 'No Image Defined') }}') center center no-repeat; background-size: cover;">
            ...
            <div class="row g-5">
                <div class="col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                    <div class="h-100 position-relative">
                        <h5 class="mb-4">Titre</h5>
                        <div class="h-100 position-relative">
                            <img src="{{ asset('frontend/img/about-1.jpg') }}" class="img-fluid w-75 rounded" alt=""
                                style="margin-bottom: 4%;">
                            <div>
                                <h6 class="mb-4"> Pellentesque aliquam dolor eget urna ultricies tiunt.Lorem ipsum
                                    dolor Télécharger le fichier PDF <a href="" download>
                                        <img src="{{ asset('pdd.png') }}" style="height: 25px; width: 25px" alt="PDF Icon">
                ...
                <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed efficitur quis purus ut interdum.
                        ...
                        vestibulum, et malesuada augue laoreetLorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
